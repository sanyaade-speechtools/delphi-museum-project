...
public class WebAppDB {
	 ...
	 */
	public boolean setAppLockout(boolean lockoutActive ) {
	 ...
	 * @throws RuntimeException for any SQL or other errors.
	 */
	public boolean uploadObjectsMetadata(String pathToLoadfile) {
	 ...
	 * @throws RuntimeException for any SQL or other errors.
	 */
	public boolean uploadCatalogCardMetadata(String pathToLoadfile) {
		// Map WinDoz paths to normal ones.
		pathToLoadfile = pathToLoadfile.replace('\\', '/');
	 ...
	 * @throws RuntimeException for any SQL or other errors.
	 */
	public boolean uploadImageMediaMetadata(String pathToLoadfile) {
		// Map WinDoz paths to normal ones.
		pathToLoadfile = pathToLoadfile.replace('\\', '/');
	 ...
	 * @throws RuntimeException for any SQL or other errors.
	 */
	public boolean uploadOntologyMetadata(
	 ...
	 * @throws RuntimeException for any SQL or other errors.
	 */
	public boolean uploadObjectCategoryAssociations(String pathToLoadfile) {
		// Map WinDoz paths to normal ones.
		pathToLoadfile = pathToLoadfile.replace('\\', '/');
		...
		retVal = uploadData( "obj_cats_wimgs", loadObjCatsWImgsStmt, null) && retVal;
		return retVal;
	}
	 ...
	 * @throws RuntimeException for any SQL or other errors.
	 */
	public boolean uploadTermStatsMetadata(String pathToLoadfile) {
		// Map WinDoz paths to normal ones.
		pathToLoadfile = pathToLoadfile.replace('\\', '/');
		String mainStmt =
	 ...
	 * @throws RuntimeException for any SQL or other errors.
	 */
	public boolean updateObjectMediaCache() {
	 ...
	 * @throws RuntimeException for any SQL or other errors.
	 */
	public boolean updateOntologyCategoryCounts() {
