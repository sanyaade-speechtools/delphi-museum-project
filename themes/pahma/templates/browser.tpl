...
<div id="contentNarrow">
	...
	<div id="browserContainer">
		<div style="top:0px" class="browser_topLevelFacet browser_topLevelFacetSelected" id="useOrContext">Use or Context</div>
		<div style="top:34px" class="browser_topLevelFacet" id="siteOrProvenience">Site or Provenience</div>
		<div style="top:68px" class="browser_topLevelFacet" id="culturalGroup">Cultural Group</div>
		<div style="top:102px" class="browser_topLevelFacet" id="material">Material</div>
		<div style="top:136px" class="browser_topLevelFacet" id="technique">Technique</div>
		<div style="top:170px" class="browser_topLevelFacet" id="color">Color</div>
		...
		<div class="browser_browsePane" id="culturalGroup_pane">
		...
		<div class="browser_browsePane" id="material_pane">
		...
		<div class="browser_browsePane" id="technique_pane">
		...
		<div class="browser_browsePane" id="color_pane">
