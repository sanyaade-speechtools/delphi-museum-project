...
<div id="content">
	...
	<span class="editSetName viewset_setName" id="setName___1">{$setName} <span class="viewset_editLink">(<a href="#">edit</a>)</span></span> 
	...
	<div id="viewset_leftCol">
		...
		<div id="viewset_objectDescription" class="viewset_box">
			...
			<div class="viewset_boxContent">
				<p id="setDescription___1" class="editSetDescription">{$setDescription} <span class="viewset_editLink">(<a href="#">edit</a>)</span></p>
			</div>
		</div>
	</div>
